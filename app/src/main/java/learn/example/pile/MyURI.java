...
public class MyURI {
   ...
   // public static final String IMAGE_JOKE_REQUEST_URL2="http://api.avatardata.cn/Joke/NewstImg";
    public static final String NEW_DATA_REQUEST_URL="http://apis.baidu.com/songshuxiansheng/news/news";
    public static final String GANK_DATA_REQUEST_URL ="http://gank.io/api/data/";
    public static final String API_KEY="d6dcb6a09e4b8890f5d6348f556ccb3e";
