...
/**
 *  {@link com.google.android.exoplayer2.ui.SimpleExoPlayerView}
 *  modify controlView to {@link CopyPlaybackControlView}
 */
@TargetApi(16)
public final class CopySimpleExoPlayerView extends FrameLayout {
  ...
  private final CopyPlaybackControlView controller;//modified
  ...
  public CopySimpleExoPlayerView(Context context) {
    this(context, null);
  }

  public CopySimpleExoPlayerView(Context context, AttributeSet attrs) {
    this(context, attrs, 0);
  }

  public CopySimpleExoPlayerView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    if (controllerPlaceholder != null) {
      ...
      // calls to set them.
      //Modify control view
      this.controller = new CopyPlaybackControlView(context, attrs);
